...
namespace APIVerve.API.CostofLiving
{
    ...
    /// <summary>
    /// Client for the CostofLiving API
    /// </summary>
    public class CostofLivingAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/costliving";
        ...
        {
            { "location", new ValidationRule { Type = "string", Required = false } },
            { "compare", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public CostofLivingAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CostofLivingAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CostofLivingAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CostofLivingQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CostofLivingQueryOptions options)
        {
        ...
        public ResponseObj Execute(CostofLivingQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CostofLivingQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CostofLivingQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CostofLivingQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CostofLivingQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CostofLivingQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CostofLivingQueryOptions options)
        {
