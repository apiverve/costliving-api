# Cost of Living API - Examples

This folder contains example code for using the Cost of Living API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/costliving',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/costliving");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/costliving](https://docs.apiverve.com/ref/costliving)
