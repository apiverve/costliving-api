...
/**
 * Client for the Cost of Living API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/costliving?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/costliving';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CostlivingClient] {$message}\n";
        }
    }
}
