...
class costlivingWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/costliving');
        }
        ...
        this.validationRules = {"location":{"type":"string","required":false},"compare":{"type":"string","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/costliving`);
        }
    }
...
module.exports = costlivingWrapper;
